...
function toggleText(titleElement) {
    var tipqualList = titleElement.closest('.tipqualList');
    var textElement = tipqualList.querySelector('.tipqual-text');
    if (textElement) {
...
function getSelectedItems() {
    ...
    checkboxes.forEach(function (checkbox) {
        var tipqualList = checkbox.closest('.tipqualList');
        selectedItems.push(tipqualList);
    });
