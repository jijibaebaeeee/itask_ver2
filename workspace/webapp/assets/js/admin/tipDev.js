...
function toggleText(titleElement) {
    var tipdevList = titleElement.closest('.tipdevList');
    var textElement = tipdevList.querySelector('.tipdev-text');
    if (textElement) {
...
function getSelectedItems() {
    ...
    checkboxes.forEach(function (checkbox) {
        var tipdevList = checkbox.closest('.tipdevList');
        selectedItems.push(tipdevList);
    });
