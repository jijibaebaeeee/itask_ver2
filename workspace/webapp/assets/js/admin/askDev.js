...
function toggleText(titleElement) {
    var askdevList = titleElement.closest('.askdevList');
    var textElement = askdevList.querySelector('.askdev-text');
    if (textElement) {
...
function getSelectedItems() {
    ...
    checkboxes.forEach(function (checkbox) {
        var askdevList = checkbox.closest('.askdevList');
        selectedItems.push(askdevList);
    });
