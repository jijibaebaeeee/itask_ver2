...
function toggleText(titleElement) {
    var asksecList = titleElement.closest('.asksecList');
    var textElement = asksecList.querySelector('.asksec-text');
    if (textElement) {
...
function getSelectedItems() {
    ...
    checkboxes.forEach(function (checkbox) {
        var asksecList = checkbox.closest('.asksecList');
        selectedItems.push(asksecList);
    });
