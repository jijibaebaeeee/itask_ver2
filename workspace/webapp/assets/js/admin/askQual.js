...
function toggleText(titleElement) {
    var askqualList = titleElement.closest('.askqualList');
    var textElement = askqualList.querySelector('.askqual-text');
    if (textElement) {
...
function getSelectedItems() {
    ...
    checkboxes.forEach(function (checkbox) {
        var askqualList = checkbox.closest('.askqualList');
        selectedItems.push(askqualList);
    });
